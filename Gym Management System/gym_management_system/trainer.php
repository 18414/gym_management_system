			...
			<div class="contact">
				...
				<form action="lib/trainer.php" enctype="multipart/form-data" method="post" name="frm_trainer" onsubmit="return validateForm(this)">
					...
					<ul class="forms">
						...
						<li class="inputfield"><input name="trainer_mobile" type="text" class="bar" required value="<?=$data[trainer_mobile]?>"/></li>
					</ul>
					<ul class="forms">
					...
					<ul class="forms">
						...
						<li class="inputfield"><input name="trainer_dob" id="trainer_dob" type="text" class="bar" required value="<?=$data[trainer_dob]?>"/></li>
					</ul>
					<ul class="forms">
					...
					<ul class="forms">
						...
						<li class="inputfield"><input name="trainer_add2" type="text" class="bar" required value="<?=$data[trainer_add2]?>"/></li>
					</ul>
					<ul class="forms">
						<li class="txt">City</li>
						<li class="inputfield">
							<select name="trainer_city" class="bar" required/>
								<?php echo get_new_optionlist("city","city_id","city_name",$data[trainer_city]); ?>
							</select>
						</li>
					</ul>
					<ul class="forms">
						...
						<li class="inputfield">
							<select name="trainer_state" class="bar" required/>
								<?php echo get_new_optionlist("state","state_id","state_name",$data[trainer_state]); ?>
							</select>
						</li>
					</ul>
					<ul class="forms">
						...
						<li class="inputfield">
							<select name="trainer_country" class="bar" required/>
								<?php echo get_new_optionlist("country","country_id","country_name",$data[trainer_country]); ?>
							</select>
						</li>
					</ul>
					<ul class="forms">
